...
<body>
    ...
    <section id="about-head" class="section-p1">
        ...
        <div>
            <h2>About Us?</h2>
            <p class="paragraph">
                DTechNex is an online store that offers a wide range of high-quality computer hardware products.
                Established in 2024, we are committed to providing our customers with the best possible shopping experience, with a
